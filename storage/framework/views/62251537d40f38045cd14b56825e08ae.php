            ...
            <div class=" md:h-[400px] xl:h-[500px] xl:w-full flex flex-col justify-center gap-5 xl:justify-between h-[calc(100dvh-90px)] items-center md:items-start ">
                ...
                <div class="flex justify-center md:justify-start mt-10 gap-1">
                    <div class="flex items-center px-5 gap-2">
                        <img src="<?php echo e(asset('images/star.png')); ?>" alt="Star-rating" class="w-[27px] xl:w-[35px]">
                        <div>
                    ...
                    <div class="flex items-center px-4 gap-2">
                        <img src="<?php echo e(asset('images/price.png')); ?>" alt="price" class="w-[27px] xl:w-[40px]">
                        <div>
                ...
                <div class="flex items-center justify-center md:justify-start mt-15">
                    <a href="<?php echo e(route('activities')); ?>" class="bg-orange-500 text-white px-6 py-2 sm:py-4 sm:px-7 rounded-[10px] hover:bg-orange-400 transition duration-300 cursor-pointer">Our Activities &#10230;</a>
                </div>
            </div>
        </div>
        ...
        <div class="container-activities flex flex-col justify-center lg:justify-normal md:mt-[30px]  h-[calc(100dvh)] sm:h-auto lg:w-[380px]">
            ...
            <div class="swiper mySwiper w-[320px] h-[500px] lg:w-[350px] xl:w-[380px] xl:h-[583px] shadow-[0_1px_25px_rgba(0,0,0,0.1)] rounded-lg">
                <div class="swiper-wrapper">
                    <?php if(isset($sliderActivities) && $sliderActivities->count() > 0): ?>
                        <?php $__currentLoopData = $sliderActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="swiper-slide">
                            <div class="rounded-2xl px-3 py-1 text-center text-white bg-green-400 absolute right-4 top-2 z-10 text-[13px] xl:text-[17px] font-semibold min-w-[60px]"><?php echo e(number_format($activity->price, 0)); ?>€</div>
                            
                            <?php if($activity->hasImageData()): ?>
                                <img src="<?php echo e($activity->image_data_url); ?>" alt="<?php echo e($activity->name); ?>" class="h-[213px] lg:w-full xl:h-[250px] lg:h-[240px] w-full">
                            <?php else: ?>
                                <?php
                                    $images = ['activity1.jpg', 'activity2.jpg', 'activity3.jpg'];
                                    $currentImage = $images[$index % count($images)];
                                ?>
                                <img src="<?php echo e(asset('images/' . $currentImage)); ?>" alt="<?php echo e($activity->name); ?>" class="h-[213px] lg:w-full xl:h-[250px] lg:h-[240px]">
                            <?php endif; ?>
                            
                            <div class="mt-5 flex justify-center items-center gap-2">
                                <img src="<?php echo e(asset('images/secondstar.png')); ?>" alt="ratings" class="w-[15px] ">
                                <p class="text-[13px] xl:text-[17px] font-bold m-0 p-0"><?php echo e($activity->average_rating); ?> <span class="text-gray-400 font-normal">(<?php echo e($activity->review_count); ?> ratings)</span></p>
                            </div>
                            
                            <div class="flex flex-col px-4 mt-7 gap-2">
                                <p class="text-[13px] xl:text-[17px] font-bold"><?php echo e($activity->name); ?></p>
                                <p class="text-[13px] xl:text-[17px] text-gray-600"><?php echo e($activity->bio); ?></p>
                            </div>
                            
                            <div class="flex justify-between items-center px-4 mt-5 gap-3">
                                <a href="<?php echo e(route('activity.detail', $activity->id)); ?>" class="bg-white text-black border border-gray-500 px-6 py-1 rounded-[20px] hover:bg-gray-200 transition duration-300 text-[13px] xl:text-[17px] w-[50%] cursor-pointer text-center">Details</a>
                                <?php if(auth()->guard()->check()): ?>
                                    <a href="<?php echo e(route('activity.booking.form', $activity->id)); ?>" class="bg-orange-500 text-white px-4 py-1 rounded-[20px] hover:bg-orange-400 transition duration-300 text-[13px] xl:text-[17px] cursor-pointer w-[50%] text-center">Book Now</a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('login')); ?>" class="bg-orange-500 text-white px-4 py-1 rounded-[20px] hover:bg-orange-400 transition duration-300 text-[13px] xl:text-[17px] cursor-pointer w-[50%] text-center">Login to Book</a>
                                <?php endif; ?>
                            </div>
                        </div>
                ...
                <?php else: ?>
                    ...
                    <div class="swiper-slide">
                        ...
                        <img src="<?php echo e(asset('images/activity1.jpg')); ?>" alt="Activity 1" class="h-[213px] lg:w-full xl:h-[250px] lg:h-[240px]">
                        ...
                        <div class="flex justify-between items-center px-4 mt-5 gap-3">
                            <a href="<?php echo e(route('activities')); ?>" class="bg-white text-black border border-gray-500 px-6 py-1 rounded-[20px] hover:bg-gray-200 transition duration-300 text-[13px] xl:text-[17px] w-[50%] cursor-pointer text-center">Details</a>
                            <a href="<?php echo e(route('activities')); ?>" class="bg-orange-500 text-white px-4 py-1 rounded-[20px] hover:bg-orange-400 transition duration-300 text-[13px] xl:text-[17px] cursor-pointer w-[50%] text-center">Book Now</a>
                        </div>
                    </div>
                <?php endif; ?>
                </div>
...
<div class="max-w-[1200px] mx-auto sm:mt-[150px] mt-[50px] ">
    ...
    <div class="max-w-[1200px] mx-auto px-5 relative">
        <img src="<?php echo e(asset('images/marina_agadir.avif')); ?>" alt="Marina Agadir" class="w-full h-[400px] xl:h-[500px] object-cover mt-[70px] rounded-lg shadow-lg blur-[2px]">
        ...
        <a href="<?php echo e(route('activities')); ?>" class="bg-orange-500 text-white px-2 py-3 rounded-lg hover:bg-orange-400 transition duration-300 absolute left-10 lg:left-15 top-60 sm:text-[22px] text-[15px]">Search activities all over Agadir &rarr;</a>
    </div>
</div>
        ...
        <?php if($activities->count() > 0): ?>
                    ...
                    <div class="group relative bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-2xl cursor-pointer">
                        ...
                        <div class="relative h-64 overflow-hidden">
                            ...
                            <div class="absolute top-4 left-4">
                                <div class="bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full flex items-center gap-1 shadow-md">
                                    ...
                                    <span class="text-sm font-semibold text-gray-800">4.<?php echo e(rand(7, 9)); ?></span>
                                </div>
                            </div>

                            <!-- Favorite Button -->
                            <button class="absolute bottom-4 right-4 w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-md cursor-pointer favorite-btn transition-all duration-300 hover:scale-110" data-activity-id="<?php echo e($activity->id); ?>">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex gap-3">
                                <a href="<?php echo e(route('activity.detail', $activity->id)); ?>" class="flex-1 bg-gradient-to-r from-gray-100 to-gray-200 text-gray-800 font-semibold py-3 px-4 rounded-xl shadow-md cursor-pointer text-center">
                                    View Details
                                </a>
                                <?php if(auth()->guard()->check()): ?>
                                    <a href="<?php echo e(route('activity.booking.form', $activity->id)); ?>" class="flex-1 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold py-3 px-4 rounded-xl shadow-md cursor-pointer text-center">
                                        Book Now
                                    </a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('login')); ?>" class="flex-1 bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold py-3 px-4 rounded-xl shadow-md cursor-pointer text-center">
                                        Login to Book
                                    </a>
                                <?php endif; ?>
                            </div>
            ...
            <div class="text-center mt-16">
                <div class="inline-flex items-center justify-center">
                    <a href="<?php echo e(route('activities')); ?>" class="bg-gradient-to-r from-orange-500 to-orange-600 text-white font-bold py-4 px-8 rounded-full shadow-xl flex items-center gap-3 cursor-pointer">
...
<div class="bg-orange-500  h-[300px] mt-[200px] w-full flex flex-col justify-between items-center">
    <div class="w-full px-5 flex justify-center items-center py-10 sm:gap-6 gap-4">
        <img src="<?php echo e(asset('images/facebook.png')); ?>" alt="" class="w-[40px] cursor-pointer">
        <img src="<?php echo e(asset('images/x.png')); ?>" alt="" class="w-[40px] cursor-pointer">
        <img src="<?php echo e(asset('images/instagram.png')); ?>" alt="" class="w-[40px] cursor-pointer">
        <img src="<?php echo e(asset('images/tik-tok.png')); ?>" alt="" class="w-[40px] cursor-pointer">
        <img src="<?php echo e(asset('images/youtube.png')); ?>" alt="" class="w-[40px] cursor-pointer">
    </div>
    <div class="items-center text-left text-white mb-[15px]">
        <p class="text-[13px]"><img src="<?php echo e(asset('images/stars-4.5.svg')); ?>" alt="" class="inline-block w-[70px] align-middle sm:w-[100px]">&nbsp &nbsp | 4.5 rating |&nbsp &nbsp 156,182 reviews &nbsp <img src="<?php echo e(asset('images/trustpilot.png')); ?>" alt="" class="inline-block ml-1 w-[20px] align-bottom sm:w-[30px]"> <span class="text-[13px]">TrustPilot</span></p>
    </div>
    <div class="mb-[30px]">
...
<?php endif; ?>
<?php /**PATH C:\Users\ziyad\Herd\BestAgadirActivities\resources\views/home.blade.php ENDPATH**/ ?>