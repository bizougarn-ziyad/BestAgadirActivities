        ...
        <div class="bg-white rounded-xl shadow-[0_1px_25px_rgba(0,0,0,0.1)] p-8 max-w-7xl mx-auto">
                ...
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-4 sm:p-6 rounded-xl border border-blue-200">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-blue-800"><?php echo e($totalBookings); ?></p>
                        </div>
                ...
                <div class="bg-gradient-to-br from-green-50 to-green-100 p-4 sm:p-6 rounded-xl border border-green-200">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-green-800"><?php echo e($totalParticipants); ?></p>
                        </div>
                ...
                <div class="bg-gradient-to-br from-purple-50 to-purple-100 p-4 sm:p-6 rounded-xl border border-purple-200 sm:col-span-2 lg:col-span-1">
                    <div class="flex items-center justify-between">
                        <div class="flex-1">
                            ...
                            <p class="text-2xl sm:text-3xl font-bold text-purple-800">$<?php echo e(number_format($totalRevenue, 2)); ?></p>
                        </div>
            ...
            <div class="space-y-6">
                <?php $__empty_1 = true; $__currentLoopData = $dailyStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $stats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="bg-gradient-to-r from-orange-50 to-yellow-50 border-2 <?php echo e($isToday ? 'border-green-400 shadow-lg' : ($isTomorrow ? 'border-blue-400' : ($isPast ? 'border-gray-300' : 'border-orange-200'))); ?> rounded-xl p-4 sm:p-6 transition-all duration-300 hover:shadow-lg">
                            ...
                            <div class="flex items-start sm:items-center gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
                                        <h3 class="text-lg sm:text-2xl font-bold text-orange-800 truncate"><?php echo e($carbonDate->format('F j, Y')); ?></h3>
                                        <?php if($isToday): ?>
                                    ...
                                    <p class="text-orange-600 font-medium text-sm sm:text-base mt-1">
                                        📊 <?php echo e($stats['total_bookings']); ?> booking<?php echo e($stats['total_bookings'] != 1 ? 's' : ''); ?> • 
                                        👥 <?php echo e($stats['total_participants']); ?> participant<?php echo e($stats['total_participants'] != 1 ? 's' : ''); ?>
                            ...
                            <div class="flex-shrink-0">
                                <div class="bg-gradient-to-r from-green-500 to-green-600 text-white px-3 py-2 sm:px-4 sm:py-2 rounded-lg shadow-md">
                                    <div class="text-center">
                                        ...
                                        <div class="text-lg sm:text-xl font-bold">$<?php echo e(number_format($stats['total_revenue'], 2)); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            <?php $__currentLoopData = $stats['bookings']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="bg-white rounded-xl border border-gray-200 p-4 sm:p-5 hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1">
                                    ...
                                    <div class="flex items-start gap-3 mb-4">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <h4 class="text-base sm:text-lg font-bold text-gray-800 truncate"><?php echo e($booking->activity->name); ?></h4>
                                            <div class="flex flex-col sm:flex-row sm:items-center gap-2 mt-1">
                                                ...
                                                <span class="text-gray-500 text-xs sm:text-sm">
                                                    Booking #<?php echo e(str_pad($booking->id, 6, '0', STR_PAD_LEFT)); ?>
                                    ...
                                    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-4">
                                        <div class="bg-blue-50 p-3 rounded-lg text-center sm:text-left">
                                            ...
                                            <div class="text-blue-800 font-bold text-lg sm:text-xl"><?php echo e($booking->participants); ?></div>
                                        </div>
                                        <div class="bg-yellow-50 p-3 rounded-lg text-center sm:text-left">
                                            ...
                                            <div class="text-yellow-800 font-bold text-sm sm:text-lg">$<?php echo e(number_format($booking->price_per_person, 2)); ?></div>
                                        </div>
                                        <div class="bg-green-50 p-3 rounded-lg text-center sm:text-left">
                                            ...
                                            <div class="text-green-800 font-bold text-lg sm:text-xl">$<?php echo e(number_format($booking->total_price, 2)); ?></div>
                                        </div>
                                        <div class="bg-purple-50 p-3 rounded-lg text-center sm:text-left col-span-2 sm:col-span-2 lg:col-span-1">
                                            ...
                                            <div class="text-purple-800 font-medium text-xs sm:text-sm"><?php echo e($booking->created_at->format('M j, g:i A')); ?></div>
                                        </div>
                                    </div>
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="text-center py-12 sm:py-16 px-4">
                        ...
                        <div>
                            <a href="<?php echo e(route('admin.bookings.index')); ?>" class="bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg transition-colors font-semibold text-sm sm:text-base">
                                Reset Filters
                            </a>
                        </div>
                    </div>
