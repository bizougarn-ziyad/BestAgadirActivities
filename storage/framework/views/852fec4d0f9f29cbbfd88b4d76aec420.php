                ...
                <div class="flex flex-wrap justify-between items-center mb-12">
                    ...
                    <div class="flex items-center gap-4">
                        <select id="sortSelect" class="bg-white border border-gray-300 rounded-lg px-4 py-2 text-gray-700 focus:outline-none focus:ring-2 focus:ring-orange-500 cursor-pointer">
                            <option value="popular" <?php echo e(($sortBy ?? 'popular') === 'popular' ? 'selected' : ''); ?>>Sort by Popular</option>
                            <option value="price_low_to_high" <?php echo e(($sortBy ?? '') === 'price_low_to_high' ? 'selected' : ''); ?>>Price: Low to High</option>
                            <option value="price_high_to_low" <?php echo e(($sortBy ?? '') === 'price_high_to_low' ? 'selected' : ''); ?>>Price: High to Low</option>
                            <option value="newest" <?php echo e(($sortBy ?? '') === 'newest' ? 'selected' : ''); ?>>Newest Added</option>
                        </select>
                    </div>
                </div>
