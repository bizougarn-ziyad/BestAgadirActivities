            ...
            <div class="grid lg:grid-cols-5 gap-8 lg:gap-16 items-start">
                ...
                <div class="lg:col-span-3 order-1 lg:order-2">
                    <div class="bg-white rounded-3xl shadow-2xl p-6 md:p-8 lg:p-12 border border-gray-100">
                            ...
                            <div class="bg-orange-50 border-l-4 border-orange-400 text-orange-700 px-6 py-4 rounded-lg mb-8">
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm">Please <a href="{{ route('login') }}" class="underline font-medium">login to your account</a> to send us a message. This helps us provide you with personalized assistance.</p>
                                    </div>
                                </div>
                            </div>
                        @endguest
                        ...
                        <form action="{{ route('contact.submit') }}" method="POST" class="space-y-6 lg:space-y-8 {{ $formDisabled ? 'opacity-50 pointer-events-none' : '' }}">
                            @csrf
                            ...
                            <div class="grid md:grid-cols-2 gap-4 lg:gap-6">
                                <div class="group">
                                    ...
                                    <input type="text" id="first_name" name="first_name" required value="{{ old('first_name') }}" {{ $formDisabled ? 'disabled' : '' }}
                                ...
                                <div class="group">
                                    ...
                                    <input type="text" id="last_name" name="last_name" required value="{{ old('last_name') }}" {{ $formDisabled ? 'disabled' : '' }}
                                           class="w-full px-4 py-3 lg:px-6 lg:py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-300 font-light text-base lg:text-lg group-hover:border-gray-300 disabled:bg-gray-100 disabled:cursor-not-allowed"
                                           placeholder="Doe">
                                </div>
                            </div>
                            ...
                            <div class="group">
                                ...
                                <input type="email" id="email" name="email" required value="{{ old('email') }}" {{ $formDisabled ? 'disabled' : '' }}
                                       class="w-full px-4 py-3 lg:px-6 lg:py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-300 font-light text-base lg:text-lg group-hover:border-gray-300 disabled:bg-gray-100 disabled:cursor-not-allowed"
                            ...
                            <div class="group">
                                ...
                                <input type="tel" id="phone" name="phone" value="{{ old('phone') }}" {{ $formDisabled ? 'disabled' : '' }}
                                       class="w-full px-4 py-3 lg:px-6 lg:py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-300 font-light text-base lg:text-lg group-hover:border-gray-300 disabled:bg-gray-100 disabled:cursor-not-allowed"
                            ...
                            <div class="group">
                                ...
                                <select id="subject" name="subject" required {{ $formDisabled ? 'disabled' : '' }}
                                        class="w-full px-4 py-3 lg:px-6 lg:py-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-all duration-300 font-light text-base lg:text-lg group-hover:border-gray-300 disabled:bg-gray-100 disabled:cursor-not-allowed">
                                    <option value="">Choose a topic</option>
                                    <option value="general_inquiry" {{ old('subject') == 'general_inquiry' ? 'selected' : '' }}>General Inquiry</option>
                                    <option value="booking_question" {{ old('subject') == 'booking_question' ? 'selected' : '' }}>Booking Question</option>
                                    <option value="custom_trip" {{ old('subject') == 'custom_trip' ? 'selected' : '' }}>Custom Trip Planning</option>
                                    <option value="group_booking" {{ old('subject') == 'group_booking' ? 'selected' : '' }}>Group Booking</option>
                            ...
                            <div class="group">
                                ...
                                <textarea id="message" name="message" rows="5" required {{ $formDisabled ? 'disabled' : '' }}
