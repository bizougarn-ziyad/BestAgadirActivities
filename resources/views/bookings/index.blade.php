                            ...
                            <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                                ...
                                <div class="flex-1 mb-4 lg:mb-0">
                                    <div class="flex items-start space-x-4">
                                        <!-- Activity Image -->
                                        @if($booking->activity && $booking->activity->image)
                                        ...
                                        <div class="flex-1">
                                            <h3 class="text-xl font-bold text-gray-800 mb-2">
                                                {{ $booking->activity ? $booking->activity->name : 'Activity Not Available' }}
                                            </h3>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-gray-600">
                                                <div class="flex items-center">
                                                    ...
                                                    <span><strong>Date:</strong> {{ $booking->booking_date->format('F d, Y') }}</span>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <span><strong>Participants:</strong> {{ $booking->participants }}</span>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <span><strong>Total Price:</strong> ${{ number_format($booking->total_price, 2) }}</span>
                                                </div>
                                                ...
                                                <div class="flex items-center">
                                                    ...
                                                    <span><strong>Booking ID:</strong> #{{ str_pad($booking->id, 6, '0', STR_PAD_LEFT) }}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="flex flex-col lg:flex-row lg:items-center space-y-3 lg:space-y-0 lg:space-x-4">
                                    ...
                                    <div class="flex justify-center lg:justify-end">
                                        <a href="{{ route('bookings.show', $booking->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg transition-colors duration-200">
