    ...
    <div class="container mx-auto px-4 pt-[120px]">
        <div class="bg-white rounded-xl shadow-[0_1px_25px_rgba(0,0,0,0.1)] p-8 max-w-4xl mx-auto">
            <div class="flex justify-between items-center mb-8">
                ...
                <a href="<?php echo e(route('admin.activities.index')); ?>" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-xl transition-all duration-300 font-semibold shadow-lg hover:shadow-xl transform hover:scale-105 flex items-center gap-2">
                            ...
                            <ul class="space-y-1 text-red-700">
                                <?php $__currentLoopData = $errors->all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $error): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="flex items-center gap-2">
                                        <span class="text-red-500">•</span> <?php echo e($error); ?>
            ...
            <!-- Form -->
            <form action="<?php echo e(route('admin.activities.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-8">
                <?php echo csrf_field(); ?>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" 
                                   ...
                                   placeholder="0.00"
                                   required
                                   class="w-full pl-12 pr-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-300 <?php echo e($errors->has('price') ? 'border-red-400' : 'border-gray-200'); ?>">
                        </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               value="<?php echo e(old('max_participants', 15)); ?>"
                               min="1"
                               max="50"
                               placeholder="15"
                               required
                               class="w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-300 <?php echo e($errors->has('max_participants') ? 'border-red-400' : 'border-gray-200'); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <textarea id="bio" 
                              ...
                              required
                              class="w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-300 resize-vertical <?php echo e($errors->has('bio') ? 'border-red-400' : 'border-gray-200'); ?>"><?php echo e(old('bio')); ?></textarea>
...
<?php endif; ?>
<?php /**PATH C:\Users\ziyad\Herd\BestAgadirActivities\resources\views/admin/add-activities.blade.php ENDPATH**/ ?>