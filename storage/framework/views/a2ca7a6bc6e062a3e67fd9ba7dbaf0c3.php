...
<head>
    ...
    <title>Edit Activity - Admin Panel</title>
                ...
                <div class="max-w-full mx-auto">
                    <div class="flex items-center justify-between mb-8">
                        <div class="flex items-center space-x-3">
                            <i class="fas fa-edit text-3xl text-orange-600"></i>
                            <h1 class="text-2xl md:text-3xl font-bold text-gray-800">Edit Activity</h1>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="border-2 border-gray-200 rounded-lg p-4">
                                ...
                                <p class="text-sm text-gray-500 mt-2 text-center">
                                    Original: <?php echo e($activity->image_original_name); ?>
                    ...
                    <!-- Form -->
                    <form action="<?php echo e(route('admin.activities.update', $activity)); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" 
                                   id="name" 
                                   name="name" 
                                   value="<?php echo e(old('name', $activity->name)); ?>"
                                   class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea id="bio" 
                                      name="bio" 
                                      rows="6"
                                      class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 resize-vertical <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      required><?php echo e(old('bio', $activity->bio)); ?></textarea>
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" 
                                           id="price" 
                                           name="price" 
                                           value="<?php echo e(old('price', $activity->price)); ?>"
                                           step="0.01"
                                           min="0"
                                           class="w-full pl-8 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 <?php $__errorArgs = ['price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="space-y-2">
                                ...
                                <input type="number" 
                                       ...
                                       value="<?php echo e(old('max_participants', $activity->max_participants)); ?>"
                                       min="1"
                                       max="50"
                                       class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 <?php $__errorArgs = ['max_participants'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="space-y-2">
                                <label for="image" class="block text-sm font-medium text-gray-700">
                                    <i class="fas fa-image mr-2"></i>New Activity Image (Optional)
                                </label>
                                <div class="relative">
                                    <input type="file" 
                                           id="image" 
                                           name="image" 
                                           accept="image/*"
                                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200 <?php $__errorArgs = ['image'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <p class="text-sm text-gray-500">
                                    ...
                                    Leave blank to keep current image. Accepted formats: JPEG, PNG, JPG, GIF. Max size: 2MB
                                </p>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div id="imagePreview" class="hidden space-y-2">
                            <label class="block text-sm font-medium text-gray-700">
                                <i class="fas fa-eye mr-2"></i>New Image Preview
                            </label>
...
<?php /**PATH C:\Users\ziyad\Herd\BestAgadirActivities\resources\views/admin/activities/edit.blade.php ENDPATH**/ ?>