                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li aria-current="page">
                        <div class="flex items-center">
                            ...
                            <span class="ml-1 text-orange-600 font-medium md:ml-2"><?php echo e($activity->name); ?></span>
                        </div>
                    </li>
                </ol>
            </nav>
                    ...
                    <div class="relative h-80 md:h-[500px] lg:h-full rounded-3xl overflow-hidden shadow-2xl">
                        ...
                        <div class="absolute top-6 left-6">
                            <div class="bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full flex items-center gap-2 shadow-md">
                                ...
                                <span class="text-sm font-semibold text-gray-800"><?php echo e($activity->average_rating); ?> (<?php echo e($activity->review_count); ?> reviews)</span>
                            </div>
                        </div>

                        <!-- Add to Favorites Button -->
                        <button class="absolute top-6 right-6 w-10 h-10 bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center shadow-md hover:bg-white transition-all duration-300 cursor-pointer group favorite-btn" data-activity-id="<?php echo e($activity->id); ?>">
                    ...
                    <div class="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-3xl font-bold text-orange-600">$<?php echo e(number_format($activity->price, 2)); ?></span>
                            </div>
                            <?php if(auth()->guard()->check()): ?>
                                <a href="<?php echo e(route('activity.booking.form', $activity->id)); ?>" class="block w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold py-4 px-6 rounded-xl text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer text-center">
                                    Book Now
                                </a>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>" class="block w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-bold py-4 px-6 rounded-xl text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer text-center">
                                    Login to Book
                                </a>
                            <?php endif; ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="bg-gradient-to-br from-green-50 to-green-100 p-8 rounded-2xl">
                    ...
                    <ul class="space-y-3">
                        ...
                        ?>
                        <?php $__currentLoopData = $whatsIncluded; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-2xl">
                    ...
                    <ul class="space-y-3">
                        ...
                        ?>
                        <?php $__currentLoopData = $goodToKnow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="flex items-start gap-3">
                                <?php
                                    $iconType = $iconTypes[$index % count($iconTypes)];
                                ?>
                                <?php if($iconType == 'clock'): ?>
                                    <svg class="w-5 h-5 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                <?php elseif($iconType == 'location'): ?>
                                    <svg class="w-5 h-5 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    </svg>
                                <?php elseif($iconType == 'weather'): ?>
                                    <svg class="w-5 h-5 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z"></path>
                                    </svg>
                                <?php elseif($iconType == 'cancel'): ?>
                                    <svg class="w-5 h-5 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                                    </svg>
                                <?php elseif($iconType == 'users'): ?>
                                    <svg class="w-5 h-5 text-blue-600 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="py-20 bg-gradient-to-br from-gray-50 to-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php $__currentLoopData = $activity->getDisplayReviews(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-white p-6 rounded-2xl shadow-lg">
                        <!-- Reviewer Info -->
                        <div class="flex items-center gap-4 mb-4">
                            <div class="w-12 h-12 bg-gradient-to-r <?php echo e($review['color']); ?> rounded-full flex items-center justify-center shadow-lg">
                                <span class="text-white font-bold text-lg"><?php echo e($review['initial']); ?></span>
                            </div>
                            <div>
                                <p class="font-semibold text-gray-800"><?php echo e($review['name']); ?></p>
                                <p class="text-sm text-gray-500"><?php echo e($review['time_ago']); ?></p>
                            </div>
                        </div>
                        <!-- Rating Stars -->
                        ...
                        <p class="text-gray-600 mb-4">"<?php echo e($review['comment']); ?>"</p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
    ...
    <div class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center">
                <a href="<?php echo e(route('activities')); ?>" class="inline-flex items-center bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 text-white font-semibold py-3 px-8 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl cursor-pointer">
...
<?php /**PATH C:\Users\ziyad\Herd\BestAgadirActivities\resources\views/activity-detail.blade.php ENDPATH**/ ?>